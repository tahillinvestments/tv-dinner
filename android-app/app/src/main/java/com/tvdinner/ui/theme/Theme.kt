...
val AVAILABLE_THEMES = listOf(
    ...
    ThemeOption(
        id = "bento",
        name = "Obsidian Bento",
        tagline = "Deep neutral obsidian, dark charcoal frames & amber glow",
...
val LocalTVDinnerColors = androidx.compose.runtime.staticCompositionLocalOf { LightTVColors }
...
fun TVDinnerTheme(
    ...
    val (colorScheme, tvColors) = when (themeKey.lowercase()) {
        ...
        "classic" -> ClassicColorScheme to ClassicTVColors
        else -> LightColorScheme to LightTVColors
    }
